...
<script type="text/javascript" src='${basepath}jsp/base/comcheckcfg/detailbasecomcheckcfg.js'></script>
...
<div class="easyui-panel"  style="width:100%;height:100%;text-align: center;"
	 data-options="footer:'#detailPageButtonsFt'">
		<form id="detailbasecomcheckcfgform" class="easyui-form" method="post" 
