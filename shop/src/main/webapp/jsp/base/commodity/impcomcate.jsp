...
<script type="text/javascript" src='${basepath}jsp/base/commodity/impcomcate.js'></script>
...
<div class="easyui-panel"  style="width:100%;height:100%;text-align: center;"
	 data-options="border:false,fit:true,footer:'#addPageButtonsFt'">
		...
		<div style="padding-top:50px">
			<a class="easyui-linkbutton" style='width:102px' iconCls='icon-excel' href='${basepath}template/BaseComCate.xls'>商品类别模板</a>
		</div>
</div>
