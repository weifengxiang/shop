...
<script type="text/javascript" src='${basepath}jsp/check/listbasecheckplan.js'></script>
...
<div id="tb" style="height: auto">
	...
	<a href="javascript:void(0)" class="easyui-linkbutton"
		data-options="iconCls:'icon-06',plain:true" onclick="detailBaseCheckPlan()">查看明细</a>
</div>
</body>
</html>